...
namespace    Core {
  /**
   *  \namespace Event
   *  \brief Namespace for every class regarding the events.
   */
  namespace  Event {
    /**
    ...
    private:
      std::unordered_map<const Core::Event::Event *, Core::Event::EventInfo>  _events; /*!< registered events and their related information. */
    ...
    public:
       ...
       */
      void  registerEvent(const Core::Event::Event *event);

      /**
       *  \brief Unregisters an event.
       *  \param event the event to unregister.
       */
      void  unregisterEvent(const Core::Event::Event *event);
       ...
       */
      void  subscribeToEvent(const Core::Event::Event *event, const std::function<void (const Core::Event::IEventArgs *)>& callback, const void *key);
       ...
       */
      void  unsubscribeFromEvent(const Core::Event::Event *event, const void *key);
    ...
    public:
       ...
       */
      void  fireEventAsync(const Core::Event::Event *event, Core::Event::IEventArgs *args) const;
