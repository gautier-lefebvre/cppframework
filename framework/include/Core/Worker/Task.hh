...
namespace    Core {
   ...
   */
  class  SimpleTask :public ATask, public Factory::TPooled<Core::SimpleTask, 15, 10> {
  public:
   ...
   */
  class  HTTPTask :public ATask, public Factory::TPooled<Core::HTTPTask, 20, 5> {
  public:
   ...
   */
  class  PeriodicTask :public ATask, public Factory::TPooled<Core::PeriodicTask, 10, 2> {
  public:
   ...
   */
  class  DelayedTask :public Factory::AFactored, public Factory::TPooled<Core::DelayedTask, 50, 10> {
  public:
