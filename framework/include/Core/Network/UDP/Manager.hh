...
namespace       Core {
  namespace     Network {
    /**
     *  \namespace Core::Network::UDP
     *  \brief UDP network classes.
     */
    namespace   UDP {
      /**
       *  \namespace Core::Network::UDP::EventArgs
      ...
      namespace EventArgs {
        ...
        public:
           ...
           */
          virtual void init(Core::Network::UDP::SocketStream* socket);
        };
        ...
        public:
           ...
           */
          virtual void init(Core::Network::UDP::SocketClient* socket);
        };
        ...
        public:
           ...
           */
          virtual void init(Core::Network::UDP::SocketServer* socket);
        };
      }
      ...
      public:
        ...
        public:
           ...
           */
          Server(uint16_t port, Core::Network::UDP::SocketServer* server, const std::set<uint32_t>& accept = {}, const std::set<uint32_t>& blacklist = {});
