...
namespace       Core {
  namespace     Network {
    /**
     *  \namespace Core::Network::TCP
     *  \brief TCP network classes.
     */
    namespace   TCP {
      /**
       *  \namespace Core::Network::TCP::EventArgs
      ...
      public:
        ...
        public:
           ...
           */
          Server(uint16_t port, Core::Network::TCP::Socket* server, const std::set<uint32_t>& accept = {}, const std::set<uint32_t>& blacklist = {});
